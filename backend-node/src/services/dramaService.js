...
function cleanupDramaGeneratedMediaRecords(db, log, dramaRow) {
  ...
  counts.scenes_cleared = applySetClauses(
    ...
    [dramaId],
    {
      image_url: null,
      local_path: null,
      reference_grid_image_url: null,
      reference_grid_local_path: null,
      extra_images: null,
      ref_image: null,
    },
    now
...
function rowToScene(r) {
  return {
    ...
    polished_prompt_nine: r.polished_prompt_nine || null,
    negative_prompt: r.negative_prompt || null,
    storyboard_count: r.storyboard_count ?? 1,
    image_url: sanitizeImageUrl(r.image_url),
    local_path: r.local_path,
    reference_grid_image_url: sanitizeImageUrl(r.reference_grid_image_url),
    reference_grid_local_path: r.reference_grid_local_path || null,
    extra_images: r.extra_images || null,
    ref_image: r.ref_image || null,
    status: r.status || 'pending',
    error_msg: r.error_msg,
